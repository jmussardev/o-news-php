                    ...
                    <fieldset class='fieldset1'>
                            ...
                            <div class="formChamps">
                                ...
                                <span class='inputChamps'>
                                    ...
                                    if ($gender === 'woman') {
                                        ...
                                        echo ' <label for="woman" class="gender_choice"> une femme /</label>';
                                        echo'<input type="radio" id="man" name="gender" value="man" >';
                                        echo ' <label for="man" class="gender_choice"> un homme </label>';
                                    }
                                    else {
                                        echo'<input type="radio" id="woman" name="gender" value="woman" >';
                                        echo ' <label for="woman" class="gender_choice"> une femme /</label>';
                            ...
                            <div class="formChamps">
                               <?php if ($prenom !== '') : ?>
                                ...
                                <input class='inputChamps2' type='text' name='prenom' id='prenom' placeholder="Prénom" value="<?= $prenom;?>">
                                <?php endif; ?>
                            </div>
                            <div class="formChamps">
